        ...
        <div className="relative overflow-hidden rounded-[1.35rem] bg-black lg:h-full">
          ...
          <div className="absolute inset-x-0 bottom-0 p-4 sm:p-5">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
              ...
              <Link
                href={href}
                className="inline-flex items-center gap-2 rounded-full bg-white/20 px-4 py-2.5 text-sm font-bold backdrop-blur-md transition-all duration-200 hover:bg-white/30 hover:scale-105 border border-white/30 shadow-lg self-start sm:self-auto"
